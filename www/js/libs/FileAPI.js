...
(function (window, undef){
	...
	var
		...
		api = {
			...
			_getFilesDataArray: function (data){
                ...
                console.log('[FileAPI][api][_getFilesDataArray()] oFiles', oFiles);

				_each(oFiles, function add(file, name){
                    console.log('[FileAPI][add][add()] ', file, name);
					if( _isArray(file) ){
	...
	function _readAs(file, fn, as, encoding){
        console.log('[FileAPI][_readAs][_readAs()] ', file, fn, as, encoding);
...
//						, src: _getUrl('http://v.demidov.boom.corp.mail.ru/uploaderfileapi/FlashFileAPI.swf?1')
				...
				patch: function (){
					...
					_inherit(api, {
						...
						getFiles: function (input, filter, callback){
                            console.log('[FileAPI][FileAPI][getFiles()] ', input, filter, callback);
							if( callback ){
								api.filterFiles(api.getFiles(input), filter, callback);
								return null;
							}
						...
						getInfo: function (file, fn){
                            console.log('[FileAPI][FileAPI][getInfo()] ', file, fn);
...
//									});
		...
		function _getUrl(url, params){
            console.log('[FileAPI][_getUrl][_getUrl()] ', url, params);
